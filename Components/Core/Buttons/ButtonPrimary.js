...
class ButtonPrimary extends Component{
    ...
    renderTouchableOpacity(text){
        return(
            <TouchableOpacity
                ...
                style={[
                styles.touchableOpacity, this.getWidth(), Theme.styles.buttonPrimaryTouchableOpacity, this.props.touchableOpacityStyle,
    ...
    renderText(){
        return(
            <Text style={[styles.text, Theme.styles.buttonPrimaryText, this.props.textStyle,
              this.state.disabled ? {opacity: 0.6} : null
    ...
    getWidth(){
        if(this.state.size == "fit"){
            return {width: 'auto', alignSelf: 'baseline'}
